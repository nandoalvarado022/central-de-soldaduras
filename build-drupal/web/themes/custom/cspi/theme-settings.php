...
function cspi_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['#attached']['library'][] = 'cspi/theme-settings';
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['breadcrumb_separator'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_separator', 'cspi'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_display'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_display', 'cspi'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_icon'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_icon','cspi'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['bootstrap_tab']['bootstrap']['bootstrap_remote_type'] = array(
    ...
    '#description'   => t('From the drop down select box, select how to load the Bootstrap library. If you select "Local" make sure that you download and place Bootstrap folder into the root theme folder (cspi/bootstrap).'),
    '#default_value' => theme_get_setting('bootstrap_remote_type', 'cspi'),
    '#options' => array(
  ...
  $form['mtt_settings']['looknfeel_tab']['looknfeel']['color_scheme'] = array(
    ...
    '#default_value' => theme_get_setting('color_scheme', 'cspi'),
    '#options' => array(
    'turquoise' => t('Turquoise (Default)'),
    'blue' => t('Blue'),
    'gray' => t('Gray'),
    'green' => t('Green'),
    'orange' => t('Orange'),
  ...
  $form['mtt_settings']['looknfeel_tab']['looknfeel']['page_container_border'] = array(
    ...
    '#default_value' => theme_get_setting('page_container_border', 'cspi'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['premium_description'] = array(
   '#type' => 'item',
   '#markup' =>
   '<div class="theme-settings-title theme-settings-title--premium-link"><a href="https://morethanthemes.com/themes/catalogplus?utm_source=catalog-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">'.t("Available in the Premium version of this theme").'</a></div>',
  );
  ...
  $form['mtt_settings']['layout_tab']['layout_modes']['premium_description'] = array(
   '#type' => 'item',
   '#markup' =>
   '<div class="theme-settings-title theme-settings-title--premium-link"><a href="https://morethanthemes.com/themes/cataloglplus?utm_source=catalog-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">'.t("Available in the Premium version of this theme").'</a></div>',
  );
